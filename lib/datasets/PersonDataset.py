...
class PersonDataset(Dataset):
    def __init__(self, dataset_name, cfg, period, aug):
        ...
        self.rst_dir = os.path.join(self.root_dir,'results_release',dataset_name,'Segmentation_rmi&ours_0.03_0.01')
        ...
        self.ann_dir = os.path.join(self.dataset_dir, 'pascal_person_part_gt')
        self.seg_dir = os.path.join(self.dataset_dir, 'pascal_person_part_gt')

        ##edge and body loss
        self.edge_dir = os.path.join(self.dataset_dir, 'person_edge')
        self.ins_dir = os.path.join(self.dataset_dir, 'person_Part_obj')
        ...
        if aug:
            ...
            file_name = self.set_dir+'/person_'+period+'.txt'
